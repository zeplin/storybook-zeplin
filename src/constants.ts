...
export const {
    ...
    STORYBOOK_ZEPLIN_PROJECT_ID: ZEPLIN_PROJECT_ID,
    STORYBOOK_ZEPLIN_STYLEGUIDE_ID: ZEPLIN_STYLEGUIDE_ID,
    STORYBOOK_ZEPLIN_PARENT_ORIGIN: PARENT_ORIGIN = "https://app.zeplin.io",
    STORYBOOK_ZEPLIN_API_URL: ZEPLIN_API_URL = "https://api.zeplin.dev",
